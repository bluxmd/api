...
const banner = cfonts.render(("HIARA REST APIS"), {
font: "block",
align: "center",
...
res.json({
status: true,
mensagem: 'HIARA REST APPIS - MELHOR SITE DE APIS',
...
if(!key.map(i => i.apikey)?.includes(apikey))return res.sendFile(path.join(__dirname, "./public/", "limited.html"))
await listkeys(apikey, req);
if (!q) return res.json({ status : false, creator : `SANDRO BOT`, message : "Cade o parametro q?"}) 
...
await listkeys(apikey, req);
url = req.query.url
 if (!url) return res.json({ status : false, criador : `SANDRO BOT`, mensagem : "Coloque o parametro: url"})
...
await listkeys(apikey, req);
q = req.query.q
 if (!q) return res.json({ status : false, criador : `SANDRO BOT`, mensagem : "Coloque o parametro: q"})
...
await listkeys(apikey, req);
nome = req.query.nome
 if (!nome) return res.json({ status : false, criador : `SANDRO BOT`, mensagem : "Coloque o parametro: nome"})
...
await listkeys(apikey, req);
signo = req.query.signo
if (!signo) return res.json({ status : false, criador : `SANDRO BOT`, mensagem : "Coloque o parametro: signo"})
...
categoria = req.query.categoria
 if (!categoria) return res.json({ status : false, criador : `SANDRO BOT`, mensagem : "Coloque o parametro: categoria"})
...
pergunta = req.query.pergunta
 if (!pergunta) return res.json({ status : false, criador : `SANDRO BOT`, mensagem : "Coloque o parametro: pergunta"})
...
texto = req.query.texto
 if (!texto) return res.json({ status : false, criador : `SANDRO BOT`, mensagem : "Coloque o parametro: texto"})
...
if(!key.map(i => i.apikey)?.includes(apikey))return res.sendFile(path.join(__dirname, "./public/", "limited.html"))
await listkeys(apikey, req);
  if (!query) return res.json({ status : false, criador : `SANDRO BOT`, mensagem : "Coloque o parametro: query"})
...
if (!url) return res.json({ status : false, creator : `SANDRO BOT`, message : "Cade o parametro url?"}) 
        if(key.includes(apikey)){
       igstory(url)
	.then(data => {
		var result = data;
...
await listkeys(apikey, req);
text = req.query.text
if (!text) return res.json({ status : false, creator : `SANDRO BOT`, message : "Cade o parametro text?"})
        if(key.includes(apikey)){
...
await listkeys(apikey, req);
query = req.query.query
if (!query) return res.json({ status : false, creator : `SANDRO BOT`, message : "Cade o parametro query?"})
wikimedia(query)
.then(hasil => {
var resultado = hasil;
res.json({
...
await listkeys(apikey, req);
url = req.query.url
if (!url) return res.json({ status : false, criador : `SANDRO BOT`, mensagem : "Coloque o parametro: q"})
...
status: true,
código: 200,
criador: `SANDRO BOTFANTASMA MODS`,
resultado: data
})})
.catch((err) =>
console.log("ERROR"));
...
status = {
    ...
    request: totalreq,
        ...
        info:{       
            owner: 'VNCSCODE',
            whatsapp: 'https://wa.me/557791009651'
        }
    }
res.json(status)
}});
